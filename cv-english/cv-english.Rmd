...
tribble(
  ...
  "PhD in Statistics", "2019-2024 (expected)", "Universidad Nacional de Rosario", "Rosario, Argentina", "I am working under the supervision of PhD. Osvaldo Martin on Bayesian statistics and exploratory data analysis. At the time, we are working on density estimators and its future implementation in the Python package Arviz.",
