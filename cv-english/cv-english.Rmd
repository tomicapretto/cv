...
github: tomicapretto
aboutme: "and please don't forget: all the data and endless computer power only gives a wonderful infinite collection of wrong models"
...
* \textbf{My thoughts in a nutshell:} More data never hurts. But in this era where everything generates data it is more necessary than ever to have the ability to ask questions and build better ideas.
